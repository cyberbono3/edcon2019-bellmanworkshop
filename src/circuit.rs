...
fn test_the_circuit() {
    ...
    {    
        //it has nothing to do with snarks, it does evaluations like this immediately after you define it
        /*
        let value = num::AllocatedNum::alloc(
            cs.namespace(|| "current value"), 
            || {
    ...
    let parameters = {
        ...
        //this function does not require you to have nay witness at all
        // it allows you to ensure your ciercuit is not depend on the witness
        //this fucntion never evaluates a witness
        //it is kind of trusted setup 
